...
=======
    ...
    // iPhone 6
    if(!strcmp(u.machine, "iPhone7,2"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
            OFFSET_ZONE_MAP                        = 0xfffffff007558478;
            OFFSET_KERNEL_MAP                      = 0xfffffff0075b4050;
            OFFSET_KERNEL_TASK                     = 0xfffffff0075b4048;
    ...
    // Apple TV 4 (2015)
    if(!strcmp(u.machine, "AppleTV5,3"))
    {
        // 10.2.2
        if(!strcmp(u.version, "14W756"))
        {
            OFFSET_ZONE_MAP                        = 0xfffffff007558478;
            OFFSET_KERNEL_MAP                      = 0xfffffff0075b4050;
            OFFSET_KERNEL_TASK                     = 0xfffffff0075b4048;
    ...
    if(!strcmp(u.machine, "iPad4,1") || !strcmp(u.machine, "iPad4,3") || !strcmp(u.machine, "iPad4,2"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad4,5") || !strcmp(u.machine, "iPad4,4") || !strcmp(u.machine, "iPad4,6"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad4,8") || !strcmp(u.machine, "iPad4,7") || !strcmp(u.machine, "iPad4,9"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad5,4") || !strcmp(u.machine, "iPad5,3"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad5,2") || !strcmp(u.machine, "iPad5,1"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad6,12") || !strcmp(u.machine, "iPad6,11"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad6,3") || !strcmp(u.machine, "iPad6,4"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad6,8") || !strcmp(u.machine, "iPad6,7"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad7,1") || !strcmp(u.machine, "iPad7,2"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPad7,3") || !strcmp(u.machine, "iPad7,4"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPhone6,2") || !strcmp(u.machine, "iPhone6,1"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPhone9,3") || !strcmp(u.machine, "iPhone9,1"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
    ...
    if(!strcmp(u.machine, "iPhone9,2") || !strcmp(u.machine, "iPhone9,4"))
    {
        // 10.3.3
        if(!strcmp(u.version, "14G60"))
        {
...
>>>>>>> master
    ...
    {
        LOG("u.machine not supported yet.");
        return FALSE;
    }
